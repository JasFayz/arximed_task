<template>
    <button v-if="sort === 'asc' || sort === null" @click="changeSort('asc')">
        <svg fill="#000000" height="16" width="16" version="1.1" id="Capa_1"
    ...
    <button v-if="sort === 'desc' || sort === null" @click="changeSort('desc')">
        <svg fill="#000000" height="16" width="16" version="1.1" id="Capa_1"
             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             viewBox="0 0 490 490" xml:space="preserve">
                    <g>
...
const changeSort = (type) => {
    ...
    emit('sortChanged', {
        param: sort.value ? props.queryParam : null,
        sort: sort.value
    })
}
